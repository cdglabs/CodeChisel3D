...
function randomPointOnSphere(radius, sphereCenter) {
    // https://gielberkers.com/evenly-distribute-particles-shape-sphere-threejs/
...
function loadConsoleScript(thenDo) {
  lively.lang.arr.mapAsyncSeries([
    ["https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.js", function() { return !!window.jQuery; }],
    ["https://lively-web.org/users/robertkrahn/just-the-core/html-console.js", function() { return !!document.querySelector("#log"); }]
